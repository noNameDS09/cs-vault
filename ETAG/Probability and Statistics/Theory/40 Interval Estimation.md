---
tags: [statistics, gate-da, interval-estimation, confidence-intervals, revision]
---

# 40 Interval Estimation

> [!note] Interval estimation provides a range of plausible values for a parameter with a specified confidence level.

---

## Overview

Interval estimation provides a range of values (confidence interval) that likely contains the true parameter, along with a confidence level indicating the reliability of the method.
...
| **Confidence Level** | $1-\alpha$ = probability CI contains true parameter |
...
### Interpretation
> "We are $100(1-\alpha)\%$ confident that the true parameter lies in this interval."
> **NOT**: "Probability parameter is in interval = $1-\alpha$" (parameter is fixed!)

### Properties of Good CI
1. **Validity**: Coverage probability $\geq 1-\alpha$
2. **Efficiency**: Short expected length
3. **Invariance**: Transformations work correctly
...
#statistics #gate-da #interval-estimation #confidence-intervals #revision